...
package com.cqrcb.dboptimize.benchbase.api;

import com.cqrcb.dboptimize.benchbase.*;
...
import com.cqrcb.dboptimize.benchbase.types.State;
import com.cqrcb.dboptimize.benchbase.types.TransactionStatus;
import com.cqrcb.dboptimize.benchbase.util.Histogram;
...
import static com.cqrcb.dboptimize.benchbase.types.State.MEASURE;

public abstract class Worker<T extends BenchmarkModule> implements Runnable {
    private static final Logger LOG = LoggerFactory.getLogger(Worker.class);
    private static final Logger ABORT_LOG = LoggerFactory.getLogger("com.cqrcb.dboptimize.benchbase.api.ABORT_LOG");
