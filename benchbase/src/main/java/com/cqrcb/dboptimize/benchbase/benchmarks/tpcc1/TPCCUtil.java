...
import com.cqrcb.dboptimize.benchbase.benchmarks.tpcc1.pojo.Customer;
...
import static com.cqrcb.dboptimize.benchbase.benchmarks.tpcc1.TPCCConfig.*;
...
public class TPCCUtil {
    ...
    public static double randomAmount(double max, Random r) {
        return new BigDecimal(r.nextDouble() * max).setScale(2, RoundingMode.FLOOR).doubleValue();
    }
